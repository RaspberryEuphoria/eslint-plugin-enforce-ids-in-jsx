...
module.exports = {
  ...
  create: function create(context) {
    ...
    var suggestionsEnabled = (options === null || options === void 0 ? void 0 : options.suggestionsEnabled) || DEFAULT_SUGGESTIONS_ENABLED;
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        ...
        if (!getAttributeValue(idAttribute)) {
          ...
          var suggestionsText = suggestionsEnabled ? ' Quick fix suggestion: `' + suggestions.map(function (suggestion, i) {
